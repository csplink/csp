...
class ProjectTest(unittest.TestCase):
    ...
    def test_project(self):
        ...
        self.assertGreater(len(project.target_chip), 0, msg="load failed.")
        ...
        self.assertGreater(len(project.gen.builder_version), 0, msg="load failed.")
        self.assertGreater(len(project.gen.hal), 0, msg="load failed.")
        self.assertGreater(len(project.gen.hal_version), 0, msg="load failed.")
        self.assertGreater(project.gen.linker.default_heap_size, -2, msg="load failed.")
        self.assertGreater(
            project.gen.linker.default_stack_size, -2, msg="load failed."
        )
        self.assertGreater(len(project.gen.toolchains), 0, msg="load failed.")
        self.assertGreater(len(project.gen.toolchains_version), 0, msg="load failed.")
