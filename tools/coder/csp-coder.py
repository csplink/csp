...
def generate_mdk_arm_project(args: dict, target_file: str) -> str:
    """
    generate mdk arm
    """
    ...
    return coder.generate_mdk_arm_project(copy.deepcopy(project), tree, keil)
...
def generate_project(env: jinja2.Environment, output_dir: str, args: dict):
    ...
    if args["Project"]["TargetProject"] == "XMake":
        ...
        output = generate_mdk_arm_project(args, path)
        file_write(path, output)
    else:
        pass
...
def main(project_file: str, output_dir: str, repositories_dir: str):
    ...
    data = {
        ...
        "ToolchainsPath": toolchains_path,
    }
