...
class Coder():
    ...
    def __file_write(self, file_path: str, data: str):
        """
        write file
        """
    ...
    def __generate_c(self, env: jinja2.Environment, module: str, dir: str, args: dict):
        """
        generate c file
        """
        if module == "main":
    ...
    def generate(self, outputDir: str, packageDir: str, toolchainsDir: str):
        """
        generate
        """
