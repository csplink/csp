...
<template>
  <el-splitter>
    <el-splitter-panel min="10%" max="50%">
    ...
    <el-splitter-panel min="50%">
      ...
      <div class="tools-div my-4 pr-4">
        <el-button type="primary" size="small" :disabled="!chip" @click="create(chip)">
          创建工程
        </el-button>
      </div>
    </el-splitter-panel>
  ...
  >
    <el-form :model="formModel" label-position="left" label-width="auto">
      <div>
        ...
        <el-form-item label="构建工具" :required="true">
        ...
        <el-form-item label="构建工具版本" :required="true">
        ...
        <el-form-item label="工具链" :required="true">
        ...
        <el-form-item label="Hal" :required="true">
