...
class Ui_CodeView(object):
    def setupUi(self, CodeView):
        ...
        self.verticalLayout_cardWidget_file = QtWidgets.QVBoxLayout(self.cardWidget_file)
        self.verticalLayout_cardWidget_file.setObjectName("verticalLayout_cardWidget_file")
